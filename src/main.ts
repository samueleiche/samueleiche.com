...
document.addEventListener('DOMContentLoaded', () => {
	...
	const svgElementPaths = Array.from(svgElement.querySelectorAll('path'))
	...
	setup.animation = animate(svgElementPaths, {
		d: (_: any /** SVGPathElement */, i: number) => nameElementPathsToMorph[i],
		ease: 'inOutQuart',
		duration: 500,
		delay: 200,
		autoplay: true,
...
function getSVG() {
	return document.querySelector('.logo') as SVGElement
}
